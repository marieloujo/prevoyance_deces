...
public class Contrat {
    ...
    private boolean assureIsSouscripteur = false;
    ...
    public Contrat(Long id, String reference) {
        this.id = id;
    ...
    public boolean isAssureIsSouscripteur() {
        return assureIsSouscripteur;
    }

    public void setAssureIsSouscripteur(boolean assureIsSouscripteur) {
        this.assureIsSouscripteur = assureIsSouscripteur;
    }
