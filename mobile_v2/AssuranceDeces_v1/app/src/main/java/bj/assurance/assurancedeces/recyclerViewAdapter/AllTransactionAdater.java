...
public class AllTransactionAdater extends RecyclerView.Adapter<TransactionViewHolder> {
    ...
    public AllTransactionAdater(Context context, List<Portefeuille> contrats) {
    ...
    public TransactionViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.item_all_transactions, parent, false);
