...
public class MessageSendAdapter extends RecyclerView.Adapter<MessageReceiveViewHolder> {

    private Context context;
    private List<Message> messages;

    public MessageSendAdapter(Context context, List<Message> messages) {
    ...
    public MessageReceiveViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new MessageReceiveViewHolder(LayoutInflater.from(context).inflate(R.layout.item_message_send, parent, false));
    }
